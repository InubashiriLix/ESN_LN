...
if __name__ == "__main__":
    # load the data
    import os
    from config import TRAIN_PATH, REGEX_PATTERN
    import logging
    ...
    for audio in os.listdir(TRAIN_PATH):
        # check format
        ...
        try:
            # get reletive path
            audio_rel_path = os.path.join(TRAIN_PATH, audio)
            ...
            signal, fs = librosa.load(audio_rel_path, sr=None)
